...
public:
    ...
    TokoElektronik() {
        etalase[0] = "Smartphone Nubia Redmagic 11 pro";
        etalase[1] = "Laptop Lenove legion Pro 7i";
...
int main() {
    ...
    do {
        ...
        cout << "\n=========================================\n";
        cout << "       SISTEM MANAJEMEN HANIF JAYA      \n";
        cout << "=========================================\n";
        ...
        switch (pilihanMenu) {
            ...
            case 3:
                ...
                break;
            case 4:
                jalankanSimulasiEtalase(tokoHanif);
                break;
            case 5:
